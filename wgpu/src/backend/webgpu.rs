...
impl crate::context::Context for ContextWebGpu {
    ...
    fn device_create_render_pipeline(
        ...
        let _ = js_sys::Reflect::set(&mapped_vertex_state, &"constants".into(), &hashmap_to_jsvalue(&desc.vertex.compilation_options.constants));
        ...
        if let Some(ref frag) = desc.fragment {
            ...
            let _ = js_sys::Reflect::set(&mapped_fragment_desc, &"constants".into(), &hashmap_to_jsvalue(&frag.compilation_options.constants));
    ...
    fn device_create_compute_pipeline(
        ...
        let _ = js_sys::Reflect::set(&mapped_compute_stage, &"constants".into(), &hashmap_to_jsvalue(&desc.compilation_options.constants));
